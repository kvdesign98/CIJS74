                ...
                <div>
                    ...
                    <div className="topMain">
                        ...
                        <div className="top">
                            ...
                            <span className="commentCount"> {item.comment_count} <img className="icon" src="https://cdn-icons-png.flaticon.com/128/54/54761.png" alt="Ảnh" /></span>
                        </div>
                    </div>

                    <h2 className="mangaName">{item.name}</h2>

                    <div className="lastestChapter">Chapter :{item.lastest_chapter}</div>
                    <div className="dateModified">{item.date_modified}</div>
